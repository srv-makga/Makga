...
enum RecvPid : uint32_t {
  ...
  ////////// item //////////
  RecvPid_ItemDestroy = 18,
  RecvPid_ItemUse = 19,
  RecvPid_ItemMake = 20,
  RecvPid_ItemReinforce = 21,
  RecvPid_ItemEnchant = 22,
  RecvPid_ItemDisassemble = 23,
  RecvPid_ItemRepair = 24,
  RecvPid_ItemSkinChange = 25,
  ////////// skill //////////
  RecvPid_SkillSpellStart = 26,
  RecvPid_SkillSpellEnd = 27,
  RecvPid_SkillLearn = 28,
  RecvPid_SkillCasting = 29,
  RecvPid_SkillCancel = 30,
  ////////// shop //////////
  RecvPid_ShopBuy = 31,
  RecvPid_ShopSell = 32,
  ////////// quest //////////
  RecvPid_QuestAccept = 33,
  RecvPid_QuestCancel = 34,
  RecvPid_QuestReward = 35,
  ////////// premium //////////
  RecvPid_PremiumBuy = 36,
  RecvPid_PremiumRefund = 37,
  RecvPid_PremiumConfirm = 38,
  ////////// party //////////
  RecvPid_PartyCreate = 39,
  RecvPid_PartyJoin = 40,
  RecvPid_PartyLeave = 41,
  RecvPid_PartyInvite = 42,
  RecvPid_PartyInviteAnswer = 43,
  RecvPid_PartyDeport = 44,
  RecvPid_PartyUpdate = 45,
  ////////// guild //////////
  RecvPid_GuildCreate = 46,
  RecvPid_GuildLeave = 47,
  RecvPid_GuildDeport = 48,
  RecvPid_GuildOptionChange = 49,
  RecvPid_GuildMemberInvite = 50,
  RecvPid_GuildMemberInviteAnswer = 51,
  RecvPid_GuildMemberChangeGrade = 52,
  ////////// friend //////////
  RecvPid_FriendAdd = 53,
  RecvPid_FriendAccept = 54,
  RecvPid_FriendRemove = 55,
  ////////// instance //////////
  RecvPid_InstanceEnter = 56,
  RecvPid_InstanceLeave = 57,
  RecvPid_InstanceSkip = 58,
  RecvPid_MIN = RecvPid_None,
  RecvPid_MAX = RecvPid_InstanceSkip
};

inline const RecvPid (&EnumValuesRecvPid())[59] {
