...
enum RecvPid : uint32_t {
  ...
  RecvPid_ActorAppear = 14,
  RecvPid_ActorDisappear = 15,
  RecvPid_ActorMove = 16,
  RecvPid_ActorChange = 17,
  ////////// item //////////
  RecvPid_ItemCreate = 18,
  RecvPid_ItemDestroy = 19,
  RecvPid_ItemUse = 20,
  RecvPid_ItemMake = 21,
  RecvPid_ItemReinforce = 22,
  RecvPid_ItemEnchant = 23,
  RecvPid_ItemDisassemble = 24,
  RecvPid_ItemRepair = 25,
  RecvPid_ItemSkinChange = 26,
  ////////// skill //////////
  RecvPid_SkillSpellStart = 27,
  RecvPid_SkillSpellEnd = 28,
  RecvPid_SkillLearn = 29,
  RecvPid_SkillCasting = 30,
  RecvPid_SkillCancel = 31,
  ////////// shop //////////
  RecvPid_ShopBuy = 32,
  RecvPid_ShopSell = 33,
  ////////// quest //////////
  RecvPid_QuestAccept = 34,
  RecvPid_QuestCancel = 35,
  RecvPid_QuestReward = 36,
  ////////// premium //////////
  RecvPid_PremiumBuy = 37,
  RecvPid_PremiumRefund = 38,
  RecvPid_PremiumConfirm = 39,
  ////////// party //////////
  RecvPid_PartyCreate = 40,
  RecvPid_PartyJoin = 41,
  RecvPid_PartyLeave = 42,
  RecvPid_PartyInvite = 43,
  RecvPid_PartyInviteAnswer = 44,
  RecvPid_PartyDeport = 45,
  RecvPid_PartyUpdate = 46,
  ////////// guild //////////
  RecvPid_GuildCreate = 47,
  RecvPid_GuildLeave = 48,
  RecvPid_GuildDeport = 49,
  RecvPid_GuildOptionChange = 50,
  RecvPid_GuildMemberInvite = 51,
  RecvPid_GuildMemberInviteAnswer = 52,
  RecvPid_GuildMemberChangeGrade = 53,
  ////////// friend //////////
  RecvPid_FriendAdd = 54,
  RecvPid_FriendAccept = 55,
  RecvPid_FriendRemove = 56,
  ////////// instance //////////
  RecvPid_InstanceEnter = 57,
  RecvPid_InstanceLeave = 58,
  RecvPid_InstanceSkip = 59,
  RecvPid_MIN = RecvPid_None,
  RecvPid_MAX = RecvPid_InstanceSkip
};

inline const RecvPid (&EnumValuesRecvPid())[60] {
