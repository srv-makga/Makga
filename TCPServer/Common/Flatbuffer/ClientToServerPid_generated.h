...
enum RecvPid : uint32_t {
  ...
  ////////// item //////////
  RecvPid_ItemDestroy = 17,
  RecvPid_ItemUse = 18,
  RecvPid_ItemMake = 19,
  RecvPid_ItemReinforce = 20,
  RecvPid_ItemEnchant = 21,
  RecvPid_ItemDisassemble = 22,
  RecvPid_ItemRepair = 23,
  RecvPid_ItemSkinChange = 24,
  ////////// skill //////////
  RecvPid_SkillSpellStart = 25,
  RecvPid_SkillSpellEnd = 26,
  RecvPid_SkillLearn = 27,
  RecvPid_SkillCasting = 28,
  RecvPid_SkillCancel = 29,
  ////////// shop //////////
  RecvPid_ShopBuy = 30,
  RecvPid_ShopSell = 31,
  ////////// quest //////////
  RecvPid_QuestAccept = 32,
  RecvPid_QuestCancel = 33,
  RecvPid_QuestReward = 34,
  ////////// premium //////////
  RecvPid_PremiumBuy = 35,
  RecvPid_PremiumRefund = 36,
  RecvPid_PremiumConfirm = 37,
  ////////// party //////////
  RecvPid_PartyCreate = 38,
  RecvPid_PartyJoin = 39,
  RecvPid_PartyLeave = 40,
  RecvPid_PartyInvite = 41,
  RecvPid_PartyInviteAnswer = 42,
  RecvPid_PartyDeport = 43,
  RecvPid_PartyUpdate = 44,
  ////////// guild //////////
  RecvPid_GuildCreate = 45,
  RecvPid_GuildLeave = 46,
  RecvPid_GuildDeport = 47,
  RecvPid_GuildOptionChange = 48,
  RecvPid_GuildMemberInvite = 49,
  RecvPid_GuildMemberInviteAnswer = 50,
  RecvPid_GuildMemberChangeGrade = 51,
  ////////// friend //////////
  RecvPid_FriendAdd = 52,
  RecvPid_FriendAccept = 53,
  RecvPid_FriendRemove = 54,
  ////////// instance //////////
  RecvPid_InstanceEnter = 55,
  RecvPid_InstanceLeave = 56,
  RecvPid_InstanceSkip = 57,
  RecvPid_MIN = RecvPid_None,
  RecvPid_MAX = RecvPid_InstanceSkip
};

inline const RecvPid (&EnumValuesRecvPid())[58] {
