...
class CSharpGenerator : public BaseGenerator {
 ...
 private:
  ...
  void GetStartOfTableVerifierClassName(const StructDef &struct_def,
                               std::string *code_ptr) {
    std::string &code = *code_ptr;
    code += "\n";
  ...
  void GetEndOfTableVerifierClassName(std::string *code_ptr) {
    std::string &code = *code_ptr;
    code += "}\n";
  }
  ...
  void GetStartOfTableVerifier(const StructDef &struct_def,
                               std::string *code_ptr) {
    std::string &code = *code_ptr;
    code += "  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)\n";
    code += "  {\n";
    code += "    return verifier.VerifyTableStart(tablePos)\n";
  }

  void GetStartOfTableVerifier2(const StructDef &struct_def,
                               std::string *code_ptr) {
    std::string &code = *code_ptr;
    code += "  static public bool Verify(Google.FlatBuffers.Verifier verifier)\n";
    code += "  {\n";
    code += "    var _bb = verifier.Buf;\n";
    code += "    uint tablePos = (uint)_bb.GetInt(_bb.Position);\n";
    code += "    return verifier.VerifyTableStart(tablePos)\n";
  }
  ...
  void GenTableVerifier(const StructDef &struct_def, std::string *code_ptr) {
    ...
    GetStartOfTableVerifierClassName(struct_def, code_ptr);
    ...
    *code_ptr += code_.ToString();
    ...
    GetStartOfTableVerifier2(struct_def, code_ptr);
    ...
    *code_ptr += code_.ToString();
    ...
    GetEndOfTableVerifierClassName(code_ptr);
  }
