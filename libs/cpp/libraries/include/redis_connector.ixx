...
public:
	// @param host: Redis 占쏙옙占쏙옙 占쌍쇽옙 (aka 127.0.0.1)
	// @param port: Redis 占쏙옙트 (aka 6379)
	...
	std::optional<std::string> GetDel(std::string_view key); // 占쏙옙占쏙옙占쏙옙 占쏙옙회 占쏙옙 占쏙옙占쏙옙, Redis 6.2+
	bool Set(std::string_view key, std::string_view value);
	bool Del(std::string_view key);

	bool SetEx(std::string_view key, std::string_view value, std::chrono::seconds ttl = std::chrono::seconds::zero()); // 占쏙옙占쏙옙 占시곤옙占쏙옙 占쌉뀐옙 占쏙옙占쏙옙
...
protected:
	// @brief Redis 占쏙옙占심억옙 占쏙옙占쏙옙
	// @param command: Redis 占쏙옙占심억옙
	// @return reply占쏙옙 nullptr 占쏙옙占쏙옙
	// @note 占쏙옙占쏙옙 占쏙옙占쏙옙 占십울옙占쏙옙占쏙옙 占쏙옙占쏙옙 占쏙옙 占쏙옙占?
	bool SendCommandNoReply(std::string&& command);

	// @brief Redis 占쏙옙占심억옙 占쏙옙占쏙옙
	// @param command: Redis 占쏙옙占심억옙
	// @return redis 占쏙옙占싱브러占쏙옙占쏙옙占쏙옙 占쏙옙환占싹댐옙 redisReply
	// @note 占쏙옙占쏙옙 占쏙옙占쏙옙 占십울옙占쏙옙 占쏙옙 占쏙옙占? 占쏙옙占쏙옙 占쏙옙占쏙옙 占쌥듸옙占?release 처占쏙옙 占쌔억옙占쏙옙
